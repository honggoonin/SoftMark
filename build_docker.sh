...
EXTRACTOR_DIR="$TOOLCHAIN_ROOT/extractor"
...
echo "SoftMark Embedder   : $RANDOMIZER_DIR/prander.py"
echo "SoftMark Extractor  : $EXTRACTOR_DIR/pextractor.py"
echo "Done...!"
echo