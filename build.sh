...
sudo apt-get install git texinfo byacc flex bison automake autoconf build-essential libtool cmake gawk elfutils python-pip radare2
...
sudo -H pip install protobuf==3.1.0 pyelftools capstone r2pipe==1.4.2 pathlib
